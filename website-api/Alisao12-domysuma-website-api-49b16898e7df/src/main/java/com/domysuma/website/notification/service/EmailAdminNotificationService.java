...
@Service
@Slf4j
public class EmailAdminNotificationService {
    final JavaMailSender javaMailSender;
    final AdminNotificationService notificationService;
    @Value("${spring.mail.username}")
    String from;

    public EmailAdminNotificationService(JavaMailSender javaMailSender, AdminNotificationService notificationService) {
    ...
    public void sendHtmlEmail(EmailAdminNotificationEvent event, AdminNotification notification) {

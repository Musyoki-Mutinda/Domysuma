...
public interface ProjectMapper {
    ...
    @Mapping(target = "yearCompleted", source = "year")
    @Mapping(target = "client", source = "clientType")
    @Mapping(target = "briefDescription", source = "description")
    Project toProjectModel(ProjectCreate projectCreate);

    @Mapping(target = "year", source = "yearCompleted")
    @Mapping(target = "clientType", source = "client")

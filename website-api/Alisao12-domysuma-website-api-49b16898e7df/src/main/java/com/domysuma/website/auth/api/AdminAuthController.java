...
public class AdminAuthController {
    ...
    @Value("${app.admin.frontend.url:https://domysumaarchitects.co.ke/admin/dashboard}")
    ...
    public ApiResponse forgotPassword(@RequestBody @Valid ForgotPasswordRequest request) {
        ...
        publisher.publishEvent(new GenericNotificationEvent<>(this, user, user.getId(), NotificationTypeEnum.FORGOT_ADMIN_PASSWORD.name()));
    ...
    public ApiResponse getAdminMe() {
        var user = adminAuthService.getMe();

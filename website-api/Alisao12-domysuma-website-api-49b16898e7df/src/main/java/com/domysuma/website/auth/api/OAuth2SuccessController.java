package com.domysuma.website.auth.controller;
...
public class OAuth2SuccessController {
    ...
    // Add this test endpoint to verify the controller is accessible
    @GetMapping("/test")
    @ResponseBody
    public String test() {
    ...
    public void oauth2Success(
        ...
        log.info("=== OAUTH2 SUCCESS ENDPOINT HIT ===");
